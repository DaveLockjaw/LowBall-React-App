...
import DropDownMultiple from './Components/DropDownMenu/DropDownMenu';
...
const App = () => {
  ...
  {/* State to hold what we recieve in class... To update components */}
  const [items, setItems] = useState([]);

  const resetThenSet = (id, key) => {
    let temp = JSON.parse(JSON.stringify([key]))
